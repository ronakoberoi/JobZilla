...
import com.JobZilla.entity.Sequence;
...
public class Utilities {
	...
	public static Long getNextSequence(String key) throws JobZillaException {
		...
		if(seq==null)throw new JobZillaException("Unable to get Sequence id for Key: "+key);
		return seq.getSeq();
	}
