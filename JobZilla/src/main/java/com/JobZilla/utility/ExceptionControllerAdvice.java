...
public class ExceptionControllerAdvice {
	...
	@ExceptionHandler(JobZillaException.class)
	public ResponseEntity<ErrorInfo> generalException(JobZillaException exception) {
		String msg=enviroment.getProperty(exception.getMessage());
