...
const Card = (props:any) => {
  return <Link to="/jobs" className="bg-mine-shaft-900 p-4 mx-5 my-3 w-72 flex flex-col gap-3 rounded-xl
  hover:shadow-[0_0_5px_1px_yellow] !shadow-bright-sun-400">
    <div className="flex justify-between">
        ...
        {props.saved?<IconBookmarkFilled stroke={1.5} className="text-bright-sun-400 cursor-pointer" />:<IconBookmark stroke={1.5} className="text-mine-shaft-300 cursor-pointer" />}
    </div>
    ...
    {(props.offered || props.interviewing) && <Divider size="xs" color="mineShaft.7" />}
    {
        props.offered && <div className="flex gap-2">
            <Button color="brightSun.4" variant="outline">Accept</Button>
            <Button color="brightSun.4" variant="light">Reject</Button>
        </div>
    }
    {
