...
return <div>
    <div className="text-2xl font-semibold mb-3 flex justify-between">About <div>
        ...
        {
         edit?<Textarea value={about} placeholder="Enter About Yourself" autosize minRows={3} onChange={(event)=> setAbout(event.currentTarget.value)}/>:<div className="text-sm text-mine-shaft-300 text-justify">
            {profile.about}
            </div>
        }
    </div>
