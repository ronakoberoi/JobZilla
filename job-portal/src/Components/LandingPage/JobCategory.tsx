...
return <div className="mt-20 pb-5">
    <div className="text-4xl text-center font-semibold mb-3 text-mine-shaft-100">
        ...
        <div className="text-lg mb-10 mx-auto text-mine-shaft-300 text-center w-1/2">Explore diverse job opportunities tailored to your skills. Start your career journey today!
         ...
         className="focus-visible:[&_button]:!outline-none [&_button]:!bg-bright-sun-400 [&_button]:!border-none 
        ...
        >
        {
            ...
            <div className="p-2 bg-bright-sun-300 rounded-full">
                <img className="h-8 w-8" src={`/Category/${category?.name?.toLowerCase?.() || "default"}.png`} alt={category?.name || "category"}
                onError={(e: any) => { e.currentTarget.src = "/Category/default.png";}} />
                </div>
